...
void move::setDistance(float distance)
{
	...
	std::cout << ">>> SetDistance = " << distance << ", timeThreshold = " << timeThreshold << std::endl;
	...
	while (1)
	{
		...
		loop_rate.sleep();
		std::cout << ">>> Distance time = " << count++ << std::endl;
...
void move::setAngular(float angular)
{
	...
	std::cout << ">>> setAngular = " << angular << ", timeThreshold = " << timeThreshold << std::endl;
	...
	while (1)
	{
		...
		loop_rate.sleep();
		std::cout << ">>> angular time = " << count++ << std::endl;
